  ...
  return (
    <nav className='border-b-2'>
        <div className='max-w-7xl mx-auto flex justify-between item-center py-8'>
            <div className='pl-2'>
                <a href="#">
                    <img src={logo} width={150} height={15} alt="vastuspaze logo" />
                </a>
            </div>
            ...
            <div className={`${isOpen ? "block" : "hidden"} md:hidden absolute bg-neutral-50 w-full py-5 px-4 mt-6 border-b-4`}>
                {
                    LINKS.map((link, index) => (
